...
\fancyhead[RE]{Projet Gestion de données distribuées GMIN210}
...
\def\titre{\LARGE Metadata graph \\Génération de graphes à partir des métadonnées.}
\def\sstitre{Projet Gestion de données distribuées GMIN210\\Rapport (Mai 2012)}
\def\auteurs{
