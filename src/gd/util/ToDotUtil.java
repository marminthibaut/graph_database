...
public class ToDotUtil {
	...
	/**
	 * @param table_bg_color the table_bg_color to set
	 */
	...
	/**
	 * @param table_font_color the table_font_color to set
	 */
	...
	/**
	 * @param graph_bg_color the graph_bg_color to set
	 */
	...
	/**
	 * @param column_bg_color the column_bg_color to set
	 */
	...
	/**
	 * @param column_font_color the column_font_color to set
	 */
